...
\section{Hardware Description}\label{HdDes}
...
$\bullet$ An USB Hub to expend the onboard USB Host port from one to four;\\
...
The detailed connection information of all hardware cables and devices is provided in both Fig. \ref{hw1}, for block diagram view, and Fig. \ref{hw2} for real view.
\begin{figure}[ht]
	\centering
...
\begin{figure}[ht]
	...
	\caption{Physical View of BBB Platform.}
	\label{hw2}
\end{figure}
